...
void CreareMatriceAdiacenta(int n, int m)
{
    for (i = 1; i <= m; i++)
    {
        ...
        a[y][x]++;//tot crestem ambele (pentru a crea corect Matricea Admitanta)
    }
}
...
int main()
{
    ...
    Write << "5 7 1 2 1 3 2 3 3 2 2 4 2 5 3 4";
    Write.close();
    ...
    EliminareLinieColoana(2);

    cout << endl;
    cout << "Exemplul 4.4.1 din curs: " << endl << endl;
