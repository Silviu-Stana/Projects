...
Shape::Shape(char* name, const Point2D& p)
{
...
class Line : public Shape
{
    ...
    public:
        Line(char* name, const Point2D& p1, const Point2D& p2) : Shape(name, p1), _point(p2) {}
...
class Triangle : public Shape
{
    ...
    public:
        Triangle(char* name, const Point2D& p1, const Point2D& p2, const Point2D& p3)
            :Shape(name, p1), _point1(p2), _point2(p3)
            {
        ...
        void Draw()
        {
            cout<<"se deseneaza triunghiul "<<_name<<" in punctele "<<_origin<<" si "<<_point1<<" si "<<_point2<<endl;
        }
};
