--create database MI2022dbStudentiXxXMihaitzaBOss69XxX
use MI2022dbStudentiXxXMihaitzaBOss69XxX
...
create table tFacultati
(codFac char(10) constraint pk_facultate primary key,
denumire varchar(40) not null)

create table tDepartamente
(codDep char(10) constraint pk_dep primary key,
denumire varchar(40) not null,
codFac char(10) constraint fk_fac foreign key references tFacultati(codFac))

create table tSpecializari
(codSpec char(10) constraint pk_spec primary key,
denumire varchar(40) not null,
codDep char(10) constraint fk_dep foreign key references tDepartamente(codDep))
...
go 
alter schema Scoala transfer dbo.tFacultati
