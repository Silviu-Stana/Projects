...
const summary = `${title} is a book published in ${publicationDate.split('-')[0]}`;
summary;
...
//HOW TO UPDATE AN IMMUTABLE ARRAY (for react)
const booksAfterUpdate = booksAfterDelete.map((book) => (book.id === 1 ? { ...book, title: 'Wowzers!' } : book));
booksAfterUpdate;
*/
