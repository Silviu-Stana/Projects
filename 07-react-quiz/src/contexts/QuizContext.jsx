...
function reducer(state, action) {
        switch (action.type) {
                ...
                case 'start':
                        return { ...state, status: 'active', index: 0, secondsRemaining: state.questions.length * SECONDS_PER_QUESTION };
                case 'restart':
...
function useQuiz() {
        ...
        if (x === undefined) throw new Error('QuizContext was used outside the QuizProvider');
        return x;
}
