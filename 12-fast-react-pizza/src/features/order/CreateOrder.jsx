                        ...
                        <Form method="POST">
                                ...
                                <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
                                        ...
                                        <div className="grow">
                                                ...
                                                {formErrors?.phone && <p className="error mt-1 rounded-full bg-red-100 p-2 text-xs">{formErrors.phone}</p>}
                                        </div>
                                </div>
                                ...
                                <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
                                        ...
                                        <div className="grow">
                                                ...
                                                {addressStatus === "error" && <p className="error mt-1 rounded-full bg-red-100 p-2 text-xs">{errorAddress}</p>}
                                        </div>
                                ...
                                <div>
                                        ...
                                        <input type="hidden" name="position" value={position.longitute ? `${position.latitude}, ${position.longitute}` : ""} />
...
export async function action({ request }) {
        ...
        //If all is okay, create order and redirect.
