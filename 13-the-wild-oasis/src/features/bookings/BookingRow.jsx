...
import { HiArrowDownOnSquare, HiArrowUp, HiEye, HiTrash } from 'react-icons/hi2';
      ...
      return (
            <Table.Row>
                  ...
                  <Stacked>
                        ...
                        <span style={{ fontSize: '1.1rem' }}>({numNights} night stay)</span>
                        <span>
                  ...
                  <Modal>
                        <Menus.Menu>
                              ...
                              <Menus.List id={bookingId}>
                                    ...
                                    {status === 'checked-in' && (
                                          <Menus.Button icon={<HiArrowUp />} onClick={() => checkout(bookingId)} disabled={isCheckingOut}>
                                                Check out
                                          </Menus.Button>
                                    )}
