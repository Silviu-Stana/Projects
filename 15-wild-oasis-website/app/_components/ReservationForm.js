...
function ReservationForm({ cabin, user }) {
    ...
    //"bookingData" becomes the 1st parameter in the "createBooking" server action
        ...
        <div className="scale-[1.01]">
            ...
            >
                ...
                <div className="flex justify-end items-center gap-6">
                    {!(startDate && endDate) ? <p className="text-primary-300 text-base">Start by selecting dates</p> : <SubmitButton>Reserve now</SubmitButton>}
                </div>
            </form>
        </div>
    );
